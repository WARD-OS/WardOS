...
//VGACols and VgaRows is for GUI And 0x0F is for Color
const int VgaCols = 80;
const int VgaRows = 25;
uint8_t TerminalColor = 0x0F;
//Terminal Color Is Color For Text


int TerminalCol = 0;
int TerminalRow = 0;
//Is for Clear Qemu information 
void TerminalClear() {
...
/*
TerminalSetColor for turn TerminalColor
*/
